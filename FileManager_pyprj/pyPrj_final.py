...
def list_documents():
    documentList = []
    documentList = os.listdir("C:/Users/dell/Documents/")
    document = Tk()
...
photo = PhotoImage(file = "C:/Users/dell/Desktop/Project_fileManager/folder.png")
...
photo2 = PhotoImage(file = "C:/Users/dell/Desktop/Project_fileManager/folder.png")
#drives
Label(disp, text = 'Drives', font =('Verdana', 15)).grid(row=30, column = 15)
photo2 = PhotoImage(file = "C:/Users/dell/Desktop/Project_fileManager/drive.png")
